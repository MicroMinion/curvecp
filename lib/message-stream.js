...
MessageStream.prototype._sendBlock = function (block) {
  ...
  var message = new Message()
  message.id = block.id
  message.acknowledging_range_1_size = this.receivedBytes
...
MessageStream.prototype.processAcknowledgments = function (message) {
  ...
  var acknowledged = []
  _.forEach(this.outgoing, function (block, last_message_id) {
    if (message.isAcknowledged(block)) {
      acknowledged.push(last_message_id)
    }
  })
  _.forEach(acknowledged, function (id) {
    var block = this.outgoing[id]
...
MessageStream.prototype.sendAcknowledgment = function (message) {
  ...
  reply.acknowledging_range_1_size = this.receivedBytes
