...
var PacketStream = function (opts) {
  ...
  if (this.serverName.length !== 256) {
    var serverName = new Uint8Array(256)
    serverName.set(new Uint8Array(new Buffer(this.serverName)))
  }
...
PacketStream.prototype.encrypt = function (data, nonce, prefixLength, from, to) {
  debug('encrypt')
  var nonce_length = 24 - prefixLength
  var short_nonce = nonce.subarray(0, nonce_length)
...
PacketStream.prototype.createNonceFromCounter = function (prefix) {
  ...
  nonce.set(new Uint8Array(new Uint64BE(this.ourNonceCounter).toBuffer()).reverse(), 16)
